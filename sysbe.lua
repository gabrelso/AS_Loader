...
-- Added Auto Strength and Auto Defense buttons in the Game Section
...
AutoStrength_Button.MouseButton1Click:Connect(function()
    ...
    if AutoStrength_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
        repeat
            pcall(function()
                AutoE()  -- Calls the AutoE function
            end)
            task.wait(0.5)
        until AutoStrength_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(255,0,0)
    end
end)
...
AutoDefense_Button.MouseButton1Click:Connect(function()
    ...
    if AutoDefense_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(0,255,0) then
        repeat
            pcall(function()
                AutoV()  -- Calls the AutoV function
            end)
            task.wait(0.5)
        until AutoDefense_Button.Ticket_Asset.ImageColor3 == Color3.fromRGB(255,0,0)
    end
end)
